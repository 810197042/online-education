...
public class Testvod {
    public static void main(String[] args) throws Exception {
        String accessKeyId = "LTAI5tDrLpKvUUihF7WhYKbw";
        String accessKeySecret = "u9wuDsa6RJgljzxfCNSEEjV1zOpu6B";
    ...
    public static void getPlayAuth() throws Exception {
        ...
        DefaultAcsClient client = AliyunVodSDKUtils.initVodClient("LTAI5tDrLpKvUUihF7WhYKbw", "u9wuDsa6RJgljzxfCNSEEjV1zOpu6B");

        GetVideoPlayAuthRequest request = new GetVideoPlayAuthRequest();
        GetVideoPlayAuthResponse response = new GetVideoPlayAuthResponse();

        request.setVideoId("b7b90730762871ee9d524531958d0102");
